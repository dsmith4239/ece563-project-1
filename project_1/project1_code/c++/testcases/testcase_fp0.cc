...
int main(int argc, char **argv){
	...
	mips->load_program("C:/Users/Smith/Desktop/NCSU/spring 23/ECE563/project/ece563-project-1/project_1/project1_code/c++/asm/codefp.asm", 0x10000000);//mips->load_program("asm/codefp.asm", 0x10000000);
